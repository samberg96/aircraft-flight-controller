...
b = 59.64; % wing span (m)
Ixx = 0.247e+8; % moment of inertia (kg m^2)
Iyy = 0.449e+8;
Izz = 0.673e+8;
Ixz = -0.212e+7;
...
a55_long = 0;
%a56_long = 0;
% a61_long = cos(theta_o);
% a62_long = sin(theta_o);
% a63_long = 0;
% a64_long = -Uo*sin(theta_o);
% a65_long = 0;
% a66_long = 0;


A_long = [a11_long, a12_long, a13_long, a14_long, a15_long; %a16_long;
    a21_long, a22_long, a23_long, a24_long, a25_long; %a26_long;
    a31_long, a32_long, a33_long, a34_long, a35_long; %a36_long;
    a41_long, a42_long, a43_long, a44_long, a45_long; %a46_long;
    a51_long, a52_long, a53_long, a54_long, a55_long]; %a56_long;
    %a61_long, a62_long, a63_long, a64_long, a65_long]; %a66_long];
...
% a63_lat = 0;
% a64_lat = 0;
% a65_lat = Uo*cos(theta_o);
% a66_lat = 0;

A_lat = [a11_lat, a12_lat, a13_lat, a14_lat, a15_lat;% a16_lat;
        a21_lat, a22_lat, a23_lat, a24_lat, a25_lat; %a26_lat;
        a31_lat, a32_lat, a33_lat, a34_lat, a35_lat;% a36_lat;
        a41_lat, a42_lat, a43_lat, a44_lat, a45_lat; %a46_lat;
        a51_lat, a52_lat, a53_lat, a54_lat, a55_lat];% a56_lat;
       % a61_lat, a62_lat, a63_lat, a64_lat, a65_lat]; %a66_lat];
...
%Parameter value (x,y,z)
%Paramvalue_y = get_param('Phase1_part3/SS_lat','')
%Paramvalue_x = get_param('Phase1_part3/SS_long','X');
%Paramvalue_z = get_param('Phase1_part3/SS_long','Z');
% Closed Loop
% cl = feedback(sys(4,1), -1);
% 
...
% sgrid
% hold off
%sim('Phase1_part3',200)
%[l1,l2] = size(Z)
%sim('Phase1_part3',500)
